...
Current baseline: 38 contract tests and 33 frontend tests pass; Ruff, typecheck, lint, and production build pass. Studionet transactions/readbacks are in [`docs/VERIFICATION.md`](docs/VERIFICATION.md).
